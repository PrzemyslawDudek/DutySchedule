INSERT INTO break(id, break_number, break_length, break_time) VALUE (1, 0, 15, '7:45 - 8:00');
...
INSERT INTO place_of_guard(id, name, is_assigned) VALUE (1, 'place1');
INSERT INTO place_of_guard(id, name, is_assigned) VALUE (2, 'place2');
INSERT INTO place_of_guard(id, name, is_assigned) VALUE (3, 'place3');
